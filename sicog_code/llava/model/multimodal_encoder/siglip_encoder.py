...
class SigLipImageProcessor:
    ...
    def preprocess(self, images, do_resize = None, do_center_crop = None, do_rescale = None, do_normalize = None, return_tensors = 'pt'):
...
class SigLipVisionEmbeddings(nn.Module):
    ...
    def resize_pos_embedding(self, position_embedding, dst_size=(28, 28), square_size=28):
