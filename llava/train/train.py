...
class ModelArguments:
    ...
    jbu_ckpt: Optional[str] = field(default="/model_weight/clip-large_jbu_4x_stack_cocostuff_attention_crf_0.001_tv_0.0_ent_0.0-0.001-True-30-2-5_2000.ckpt")
...
def preprocess_qwen(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False, max_len=2048, system_message: str = "You are a helpful assistant.") -> Dict:
    ...
    # print(Fore.CYAN + Style.BRIGHT + "Processing data with preprocess_qwen...." + Style.RESET_ALL)
...
def preprocess_v1(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False) -> Dict:
    conv = conversation_lib.default_conversation.copy()
    roles = {"human": conv.roles[0], "gpt": conv.roles[1]}
    # print(Fore.CYAN + Style.BRIGHT + "Processing data with preprocess_v1...." + Style.RESET_ALL)
